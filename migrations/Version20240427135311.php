 ...
 */
final class Version20240427135311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE command ADD CONSTRAINT FK_8ECAEAD4ECECCB64 FOREIGN KEY (command_id_id) REFERENCES shef (id)');
